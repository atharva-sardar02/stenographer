...
interface TemplateData {
  ...
  description: string;
  sections: {
    facts: { title: string; prompt: string; content: string };
    liability: { title: string; prompt: string; content: string };
    damages: { title: string; prompt: string; content: string };
    demand: { title: string; prompt: string; content: string };
  };
  variables: Array<{
    name: string;
    label: string;
...
async function createTemplates() {
  ...
  const slipAndFallTemplate: TemplateData = {
...
[Contact Information]`
  ...
  const workplaceInjuryTemplate: TemplateData = {
