...
exports.manualPurge = exports.retentionPurge = exports.createDemoTemplate = exports.updateUserProfile = exports.onFileCreate = exports.extractTextFromFile = exports.onUserCreate = exports.exportGenerate = exports.draftRefineSection = exports.draftGenerate = exports.ocrExtract = void 0;
...
const drafts_1 = require("./services/drafts");
    ...
    corsHandler(request, response, async () => {
        ...
        try {
            ...
            if (fileExtension === 'pdf') {
                ocrResult = await (0, ocr_1.extractTextFromPdf)(storagePath);
            }
            else if (['jpg', 'jpeg', 'png', 'gif'].includes(fileExtension || '')) {
                ocrResult = await (0, ocr_1.extractTextFromImage)(storagePath);
            }
            else {
...
exports.draftRefineSection = functions
    ...
    corsHandler(request, response, async () => {
        ...
        try {
            ...
            // Refine section
            const content = await (0, drafts_1.refineSection)(draftId, section, instruction, keepExistingContent !== false, // Default to true
            userId);
            response.status(200).json({
                success: true,
                content,
...
exports.exportGenerate = functions
    ...
    corsHandler(request, response, async () => {
        ...
        try {
            ...
            const docxBuffer = await (0, export_1.generateDocx)(content, options || {});
            ...
            const downloadUrl = await (0, export_1.uploadDocxToStorage)(docxBuffer, exportId, fileName);
 ...
 */
exports.extractTextFromFile = functions
    .region('us-central1')
 ...
 */
exports.createDemoTemplate = functions
    .region('us-central1')
    .https
