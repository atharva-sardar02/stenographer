...
export const GoogleAuthButton: React.FC<GoogleAuthButtonProps> = ({
  ...
  const baseClasses =
    'w-full py-2 px-4 font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2';
